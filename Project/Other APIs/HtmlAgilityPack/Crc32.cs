namespace HtmlAgilityPack
{
    ...
    public class Crc32
    {
        ...
        public static uint CRC32Bytes(byte[] bytes)
        {
            ...
            {
                length--;
                maxValue = UPDC32(bytes[length], maxValue);
            }
            return ~maxValue;
        }
        ...
        public static uint CRC32String(string text)
        {
            ...
            {
                length--;
                ushort num3 = text[length];
                byte octet = (byte)(num3 & 0xff);
                byte num5 = (byte)(num3 >> 8);
                maxValue = UPDC32(num5, maxValue);
                maxValue = UPDC32(octet, maxValue);
            }
            return ~maxValue;
        }
        ...
        {
            return (crc_32_tab[(int)((IntPtr)((crc ^ octet) & 0xff))] ^ (crc >> 8));
        }
