...
using Lerp2Assets.Utility;
using UnityEngine;
using Random = UnityEngine.Random;

//Tengo que renombrar esto... (I have to)
//Y añadir el de la tercera persona, y sus variantes.
namespace Lerp2Assets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField]
        private AudioClip[] m_FootstepSounds = new AudioClip[2];    // an array of footstep sounds that will be randomly selected from.
        ...
        private void LateUpdate()
        {
            if (Input.GetKeyDown(KeyCode.F8))
                m_MouseLook.smooth = !m_MouseLook.smooth;
        }
