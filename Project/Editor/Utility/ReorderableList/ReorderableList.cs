...
namespace Malee.Editor
{
    ...
    public partial class ReorderableList
    {
        ...
        /// <summary>
        /// Delegate DrawFooterDelegate
        /// </summary>
        /// <param name="rect">The rect.</param>
        public delegate void DrawFooterDelegate(Rect rect);

        /// <summary>
        /// Delegate DrawElementDelegate
        /// </summary>
        /// <param name="rect">The rect.</param>
        ...
        /// <summary>
        /// Delegate DragDropReferenceDelegate
        /// </summary>
        ...
        /// <summary>
        /// Delegate DragDropAppendDelegate
        /// </summary>
        ...
        /// <summary>
        /// Delegate GetElementHeightDelegate
        /// </summary>
        /// <param name="element">The element.</param>
        ...
        /// <summary>
        /// Delegate GetElementsHeightDelegate
        /// </summary>
        /// <param name="list">The list.</param>
        /// <returns>System.Single.</returns>
        ...
        /// <summary>
        /// Delegate GetElementNameDelegate
        /// </summary>
        /// <param name="element">The element.</param>
        ...
        /// <summary>
        /// The show default background
        /// </summary>
        public bool showDefaultBackground;

        /// <summary>
        /// The element display type
        /// </summary>
        ...
        /// </summary>
        /// <param name="list">The list.</param>
        /// <param name="canAdd">if set to <c>true</c> [can add].</param>
        /// <param name="canRemove">if set to <c>true</c> [can remove].</param>
        ...
        /// <param name="canRemove">if set to <c>true</c> [can remove].</param>
        /// <param name="draggable">if set to <c>true</c> [draggable].</param>
        /// <param name="elementDisplayType">Display type of the element.</param>
        /// <param name="elementNameProperty">The element name property.</param>
        /// <param name="elementIcon">The element icon.</param>
        ...
        /// <param name="elementIcon">The element icon.</param>
        /// <exception cref="MissingListExeption"></exception>
        /// <exception cref="Malee.Editor.ReorderableList.InvalidListException"></exception>
        ...
        /// <summary>
        /// Gets a value indicating whether this instance has list.
        /// </summary>
        /// <value><c>true</c> if this instance has list; otherwise, <c>false</c>.</value>
        public bool HasList
        {
        ...
        /// <summary>
        /// Determines whether [has keyboard control].
        /// </summary>
        /// <returns><c>true</c> if [has keyboard control]; otherwise, <c>false</c>.</returns>
        ...
        private class SlideGroup
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="SlideGroup"/> class.
            /// </summary>
            public SlideGroup()
            {
        ...
        private class ListSelection : IEnumerable<int>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ListSelection"/> class.
            /// </summary>
            ...
            /// <summary>
            /// Determines whether [contains] [the specified index].
            /// </summary>
            /// <param name="index">The index.</param>
        ...
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="InvalidListException"/> class.
            /// </summary>
        ...
        {
            /// <summary>
            /// Initializes a new instance of the <see cref="MissingListExeption"/> class.
            /// </summary>
