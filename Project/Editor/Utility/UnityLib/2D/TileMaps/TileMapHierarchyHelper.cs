...
[InitializeOnLoad]
internal class TileMapHierarchyHelper
{
    private static Texture2D tilemapIcon, tilemapIconDisabled, upArrow, downArrow;
    ...
    private static void MoveInHierarchy(GameObject go, int delta)
    {
