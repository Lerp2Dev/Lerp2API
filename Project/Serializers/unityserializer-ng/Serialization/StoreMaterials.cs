...
namespace Serialization
{
    ...
    public partial class StoreMaterials : MonoBehaviour
    {
        ...
        /// </summary>
        private static Index<string, List<MaterialProperty>> cache = new Index<string, List<MaterialProperty>>();
        ...
        private void OnEnable()
        {
            ...
            if (!Dirty)
            {
                ...
                foreach (Material mat in renderer.sharedMaterials)
                    try
                    {
                        if (!ShaderDatabase.ContainsKey(mat.shader.name)) //mat != null && mat.shader != null && ShaderDatabase != null
                        {
                            Dirty = true;
                            break;
                        }
