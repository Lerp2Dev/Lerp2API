...
"%MSBuild%\MSBuild.exe" "%MAIN_PATH%\Lerp2API.sln" /t:Lerp2Console /pp /p:ReferencePath="%REF_PATH%; %MAIN_PATH%\Compile\Console\Assemblies" /p:Platform="Any CPU" /p:OutputPath=../../Build/Console /p:Configuration=Debug
